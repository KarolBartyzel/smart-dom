...
export default function HomeScreen() {
    ...
    return (
        <View style={styles.container}>
            {!error && !transcript && <VoiceRecognizer finishedRecognition={finishedVoiceRecognition} />}
            {!error && transcript && !command && <CommandRecognizer transcript={transcript} finishedRecognition={finishedCommandRecognition} />}
